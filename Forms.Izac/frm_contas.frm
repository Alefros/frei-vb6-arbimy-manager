...
Call Desabilitar
            ...
            If msk_agencia = "" Then MsgBox "DIGITE UMA AGENCIA VÁLIDA", vbInformation, "TRICON SUPERMERCADOS LTDA.": msk_agencia.SetFocus: Exit Sub
            ...
            If msk_conta = "" Then MsgBox "DIGITE UMA CONTA CORRENTE VÁLIDA", vbInformation, "TRICON SUPERMERCADOS LTDA.": msk_conta.SetFocus: Exit Sub
            End If
            Call gravar_contas
